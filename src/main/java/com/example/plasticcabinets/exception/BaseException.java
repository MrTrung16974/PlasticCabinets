package com.example.plasticcabinets.exception;

import com.example.plasticcabinets.config.PropertiesConfig;
...
public class BaseException {
    ...
    @Autowired
    public BaseException(PropertiesConfig propertiesConfig) {
        BaseException.propertiesConfig = propertiesConfig;
    }
